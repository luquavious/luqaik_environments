...
st.markdown("How Gini coefficient, life expectancy and more range internationally and within deciles of a population.")
...
fig1.update_layout(
    ...
    margin=dict(t=1000)  # Reduce top margin
)
